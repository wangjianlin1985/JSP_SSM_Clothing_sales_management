		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>LostProduct/frontlist">丢失服装列表</a></li>
			    	<li role="presentation" class="active"><a href="#lostProductAdd" aria-controls="lostProductAdd" role="tab" data-toggle="tab">添加丢失服装</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="lostProductAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="lostProduct_productObj_productId" class="col-md-2 text-right">丢失服装:</label>
						  	 <div class="col-md-8">
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxLostProductAdd();" class="btn btn-primary bottom5 top5">登记</span>
				          </div>
						</form> 
...
var basePath = "<%=basePath%>";
	...
	function ajaxLostProductAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "LostProduct/empAdd",
			dataType : "json" , 
