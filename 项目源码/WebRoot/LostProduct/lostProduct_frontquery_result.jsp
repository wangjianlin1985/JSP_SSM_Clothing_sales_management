		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#lostProductListPanel" aria-controls="lostProductListPanel" role="tab" data-toggle="tab">丢失服装列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>LostProduct/lostProduct_frontAdd.jsp" style="display:none;">添加丢失服装</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录id</td><td>丢失服装</td><td>丢失数量</td><td>丢失时间</td><td>丢失地点</td><td>总价值</td><td>操作员</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<lostProductList.size();i++) {
					    	            		...
					    	            		LostProduct lostProduct = lostProductList.get(i); //获取到丢失服装对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="lostProductQueryForm" id="lostProductQueryForm" action="<%=basePath %>LostProduct/frontlist" class="mar_t15">
            <div class="form-group">
            	<label for="productObj_productId">丢失服装：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;丢失服装信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="lostProduct_productObj_productId_edit" class="col-md-3 text-right">丢失服装:</label>
		  	 <div class="col-md-9">
