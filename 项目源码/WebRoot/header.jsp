...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">服装仓库管理</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>Member/frontlist">会员</a></li>
                 ...
                 <li><a href="<%=basePath %>ProductClass/frontlist">服装类别</a></li>
                ...
                <li><a href="<%=basePath %>Product/frontlist">服装查询</a></li>
                <li><a href="<%=basePath %>BuyInfo/frontlist">服装采购</a></li> 
                <li><a href="<%=basePath %>Sell/frontlist">销售日志</a></li>
                <li><a href="<%=basePath %>Attendance/frontlist">考勤信息</a></li>
               <li><a href="<%=basePath %>LostProduct/frontlist">丢失服装查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>BuyInfo/buyInfo_frontEmpAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;服装采购登记</a></li>
                        <li><a href="<%=basePath %>BuyInfo/empFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的采购记录</a></li>
                        <li><a href="<%=basePath %>SellCart/sellCart_empFrontAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;服装销售登记</a></li>
                        <li><a href="<%=basePath %>LostProduct/lostProduct_frontEmpAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;丢失服装登记</a></li>
